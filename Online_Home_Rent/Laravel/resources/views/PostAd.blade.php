              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-8 form-group">
                     <input type="text" id="textBox" placeholder="" class="form control" name="pname">
                  </div>
                </div>
              </div>
          </div>
          ...
          <!-- Username -->
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-8 form-group">
                     <input type="text" id="textBox2"placeholder="" class="input-xlarge" name="address">
                  </div>
                </div>
              </div>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-6 form-group" style="padding-right:0">
                     <input type="text" id="textBox"  placeholder="" class="input-xlarge" name="size"><label>(Square ft)</label> 
                  </div> 
                </div>
              </div>
          </div>
          ...
          <!-- Username -->
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-8 form-group">
                     <input type="text" id="largerTextBox"  placeholder="" class="input-xlarge" name="description">
                  </div>
                </div>
              </div>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-4 form-group">
                     <input type="text" id="textBox"  placeholder="" class="input-xlarge" name="price"><label>(TK)</label>
                  </div>
                  <div class="col-md-4 form-group">
