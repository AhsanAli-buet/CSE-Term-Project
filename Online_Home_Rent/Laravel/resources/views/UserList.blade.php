...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <!-- column 2 -->
            <a href="#"><strong> User List</strong></a>
                    
            <!--/row-->

            <hr>
            <!---Here should be the codes of User List-->

            <div class="row">
                    <div class="col-md-3" style="text-left"><h3>Username</h3></div>
                    <div class="col-md-3" style="text-right"><h3>Email</h3></div>
                    <div class="col-md-3" style="text-left"><h3>Delete</h3></div>
                    <div class="col-md-3" style="text-right"><h3>Notify</h3></div>
                    <br>
                    <br>
                    <hr>
            </div>
            ...
            @for($i=0;$i<count($user_data);$i++)
                <div class="row">
                        ...
                        <div class="col-md-3" style="text-left"><label>{{ $user_data[$i]->username}}</label></div>
                        <div class="col-md-3" style="text-right"><label>{{$user_data[$i]->email}}</label></div>
                        <?php $link2 = "/DeleteUser/".$user_data[$i]->userid; ?>
                        <div class="col-md-3" style="text-left"><a class="btn btn-info" href="{{URL::to($link2)}}"> Delete</a></div>
                        <div class="col-md-3" style="text-right"><a class="btn btn-success" href="">Notify</a></div>
                        <hr>
                </div>
                <hr>
